...
error_reporting(E_ERROR);
    ...
    $sql = "SELECT * FROM users WHERE user LIKE '$userkookie'";
    $result = $conn->query($sql);
    $user = mysqli_query($conn, "SELECT * FROM users WHERE user = '$userkookie'");
    $user = mysqli_fetch_assoc($user);
    $sqlquery = "SELECT * FROM users WHERE user LIKE '$userkookie'";
...
<br><br><br><br><br><br><br>
          <label class="goldentxt">ჩექლისტი წარმატებით დაემატა.</label>
          <br><br><br>
          <a class="btn btn-success" href="../../addchecklist.php">უკან დაბრუნება</a>
