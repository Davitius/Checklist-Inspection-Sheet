...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
<br><br><br><br><br>
          <label class="goldentxt">პაროლი არ შეესაბამება მოთხოვნებს!</label>
          <br>
          <label class="goldentxt">პაროლი უნდა იყოს მინიმუმ 5 სიმბოლო და მაქსიმუმ 12 სიმბოლო.</label>
          <br><br><br>
          <a class="btn btn-danger" href="../../index.php">უკან დაბრუნება</a>
