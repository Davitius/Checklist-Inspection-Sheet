  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
          <img class="mainlogo" src="img/archi-logo.png" href="https://www.archi.ge/ge">
          <br><br><br><br><br>
          <!-- Authentication  -->
...
<!-- Add changelog  -->
          <form action="php/changelogcheck.php" method="post" enctype="multipart/form-data">
              <br><br><br>
              <label  class="goldentxtbig">პროგრამის ცვლილებების ჟურნალი</label>
              <br><br>
              <label  class="goldentxt">News:</label>
            <input type="text" class="form-control" name="news"
                   id="news" placeholder="" value="">
              <br>
              <label  class="goldentxt">ცვლილებების ჟურნალი:</label>
              ...
              <br><br>
                <div class="btn-group">
                    <button class="btn btn-warning" name="chagelogupdate"type="submit">დამატება</button>
...
<?php
        $conn = new mysqli('localhost', 'root', 'root', 'projectsdb');
        $sql = "SELECT * FROM arqi_changelog ORDER BY id DESC LIMIT 10";
         $result = $conn->query($sql);
