...
<header>
      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled">
           <li><a href="en/index.php" class="text-white"><img class="lang" src="img/en.png"></a>
  ...
  <path d="M2 11h1v1H2v-1zm2 0h1v1H4v-1zm-2 2h1v1H2v-1zm2 0h1v1H4v-1zm4-4h1v1H8V9zm2 0h1v1h-1V9zm-2 2h1v1H8v-1zm2 0h1v1h-1v-1zm2-2h1v1h-1V9zm0 2h1v1h-1v-1zM8 7h1v1H8V7zm2 0h1v1h-1V7zm2 0h1v1h-1V7zM8 5h1v1H8V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm0-2h1v1h-1V3z"/>
      ...
      <ul class="list-unstyled text-small">
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="../index.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#316eac" class="bi bi-house-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6zm5-.793V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
</svg> <label class="goldentxtsmall">პროექტები</label></a></li>
        </ul>
...
?>
  ...
  <path d="M2 11h1v1H2v-1zm2 0h1v1H4v-1zm-2 2h1v1H2v-1zm2 0h1v1H4v-1zm4-4h1v1H8V9zm2 0h1v1h-1V9zm-2 2h1v1H8v-1zm2 0h1v1h-1v-1zm2-2h1v1h-1V9zm0 2h1v1h-1v-1zM8 7h1v1H8V7zm2 0h1v1h-1V7zm2 0h1v1h-1V7zM8 5h1v1H8V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm0-2h1v1h-1V3z"/>
          ...
          <!-- Authentication -->
          <label class="goldentxtbig">ავტორიზაცია</label>
          <br><br>
<form action="php/auth.php" method="post">
<br />
    <label class="visually-hidden">მომხმარებლის სახელი</label>
    <input type="text" id="user" class="form-control" name="user" placeholder="E-mail" autofocus required>
    <label class="visually-hidden">პაროლი</label>
    <input type="password" id="pass" class="form-control" name="pass" placeholder="პაროლი" required>
    <br>
...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
          <label class="goldentxtbig">მოგესალმები </label><br>
          <label class="goldentxt">თქვენ ავტორიზებული ხართ როგორც:</label><br>
        ...
        <img class="userphoto" src="data:image/jpeg;base64, <?php echo $show_img ?>" alt="">
          ...
          <!-- Personal info  -->
          <label class="goldentxtbig">თქვენი მონაცემები:</label>
          <br><br>
...
<br>
  ...
  <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm-.55 8.502L7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0zM8.002 12a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
              ...
              <br><br><br>
              <label  class="goldentxtbig">პაროლის ან/და ფოტოს შეცვლა</label>
              <br><br>
...
<!-- Change log  -->
        ...
        $sql = "SELECT * FROM arqi_changelog ORDER BY id DESC LIMIT 5";
         $result = $conn->query($sql);
          ...
          <label class="goldentxt">ბოლო ცვლილება - <?php echo $rowww->timme ?></label>
          <br><br>

          <div class="panel-group" id="collapse-group">
                        <div class="btn btn-light">
                            <div class="panel-heading">
                            <a data-toggle="collapse" data-parent="#collapse-group" href="#el1">ცვლილებების  ჟურნალი</a>
                            </div>
