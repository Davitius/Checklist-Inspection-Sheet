...
<br><br><br><br><br><br><br>
          <label class="goldentxt">The password does not meet the requirements!</label>
          <br>
          <label class="goldentxt">The password must be a minimum of 5 characters and a maximum of 12 characters.</label>
          <br><br><br>
          <a class="btn btn-danger" href="../../users.php">Return back</a>
