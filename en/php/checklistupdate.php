...
<section class="py-5 text-center container">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <label  class="goldentxtbig">Change in checklist</label>
        ...
        <option value="2 pack">2 pack</option>
          ...
          <label  class="goldentxt">I agree: </label>
              ...
              <br><br><br>
          <div class="btn-group">
                    <button class="btn btn-warning" name="checklistupdate"type="submit">Update</button>
                  <input type="submit" class="btn btn-danger" name="checklistdelete" value="Delete">
                    <a class="btn btn-success" href="../checklists.php">Back</a>
