...
<section class="py-5 text-center container">
  ...
  <path d="M2 11h1v1H2v-1zm2 0h1v1H4v-1zm-2 2h1v1H2v-1zm2 0h1v1H4v-1zm4-4h1v1H8V9zm2 0h1v1h-1V9zm-2 2h1v1H8v-1zm2 0h1v1h-1v-1zm2-2h1v1h-1V9zm0 2h1v1h-1v-1zM8 7h1v1H8V7zm2 0h1v1h-1V7zm2 0h1v1h-1V7zM8 5h1v1H8V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm0-2h1v1h-1V3z"/>
          ...
          <br><br>
        <label  class="goldentxtbig">Checklist</label>
          <br>
          <label class="goldentxt">ID-<?= $checklist['id'] ?></label>
          <br><br>
          <label  class="goldentxt">Project title: <?= $checklist['project'] ?></label>
          <br>
          <label  class="goldentxt">Date: <?= $checklist['timme'] ?></label>
          <br>
          <label  class="goldentxt">Apartment number: <?= $checklist['place'] ?></label>
          <br>
              <label  class="goldentxt">Floor: <?= $checklist['floor'] ?></label>
            <br>
            <label  class="goldentxt">Quality controller: <?= $checklist['user'] ?></label>
          <br>
          <label  class="goldentxt">Name / surname of the</label>
          <br>
          <label class="goldentxt">owner and / or proxy  --------------------------</label>
          <br><br>
            <table border="2">
                <thead>
                <tr>
          ...
          <br>
                ...
                <textarea class="form-control" type="text" placeholder="Additional information" name="comment" cols="70" rows="3" maxlength="295" id="comment"><?= $checklist['comment'] ?></textarea>
          <br><br>
          <label  class="goldentxt">I agree to rent the apartment in its current condition</label>
          <br><br>
          <label  class="goldentxt">Yes </label>
          <br><br><label  class="goldentxt">No </label>
          <br><br>
          <label  class="goldentxt">Owner's signature  --------------------------</label>
          <br><br>
          <label  class="goldentxt">Signature of Service Manager  --------------------------</label>
          <br><br>
      </div>
    </div>
  </section>
