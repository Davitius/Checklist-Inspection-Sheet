...
<main>
  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <label class="goldentxtbig">Checklists</label>
          <br>
          <br><br>
<?php
      $conn = new mysqli('localhost', 'root', 'root', 'projectsdb');
     if(isset($_GET['search'])){
        $searchKey = $_GET['search'];
         $searchKeytemp = "t87ჰგჯგ7tt";

         if(!$searchKey == ""){
        $sql = "SELECT * FROM arqi_checklists WHERE project LIKE '%$searchKey%'";
         }
     else{
     $sql = "SELECT * FROM arqi_checklists WHERE project LIKE '%$searchKeytemp%'";
     }
     $result = $conn->query($sql);
     }
?>
...
<!-- Checklist search  -->
          <form action="" method="GET">
                      <div class="btn-group">
        <input type="text" name="search" class='form-control' placeholder="Checklist search" value=<?php echo @$_GET['search']; ?> >

      <input class="btn btn-primary" type="submit" value="Search"/>
         <a class="btn btn-primary" href="checklists.php">Reset</a>
</div>
   </form>
            ...
            <table border="2">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                        <a class="btn btn-success" href="php/checklistinfo.php?id=<?php echo $row->id ?>">
  ...
  <path fill-rule="evenodd" d="M6.5 3a.5.5 0 0 1 .5.5V6h2.5a.5.5 0 0 1 0 1H7v2.5a.5.5 0 0 1-1 0V7H3.5a.5.5 0 0 1 0-1H6V3.5a.5.5 0 0 1 .5-.5z"/>
                        ...
                        <a class="btn btn-warning" href="php/checklistupdate.php?id=<?php echo $row->id ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
