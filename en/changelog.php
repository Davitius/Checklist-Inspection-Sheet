...
<!-- Add changelog  -->
          <form action="php/changelogcheck.php" method="post" enctype="multipart/form-data">
              <br><br><br>
              <label  class="goldentxtbig">Journal of program changes</label>
              <br><br>
             <!-- <label  class="goldentxt">News:</label>
            <input type="text" class="form-control" name="news"
                   id="news" placeholder="" value=""> -->
              <br>
              <label  class="goldentxt">Log of Changes:</label>
              <textarea class="form-control" name="changes" id="changes" placeholder="Performed change"></textarea>
              <br>
              <label  class="goldentxt">I agree: </label>
              <input type="checkbox" name="" required>
              <br><br>
                <div class="btn-group">
                    <button class="btn btn-warning" name="chagelogupdate"type="submit">Add</button>
